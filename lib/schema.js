...
module.exports = function (gridFSStorage) {
   ...
   * @function
   * @name read
   * @param {Object} [options] has start and end properties for specifing range
   ...
   * });
   */
  GridFSSchema.methods.read = function (options, done) {
    //stream file out of gridfs
    return gridFSStorage.readById(this._id, options, done);
  };
   ...
   */
  GridFSSchema.statics.readByFileName = function (filename, options, done) {
    return gridFSStorage.readByFileName(filename, options, done);
  };
   ...
   */
  GridFSSchema.statics.readById = function (id, options, done) {
    return gridFSStorage.readById(id, options, done);
  };
