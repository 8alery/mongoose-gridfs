 ...
 *
 */
GridFSStorage.prototype.readById = function readById(id, options, done) {

  // TODO support options
  // openDownloadStream(id, options)

  //create a readable stream for a specific file
  const stream = this.storage.openDownloadStream(id, options);
...
GridFSStorage.prototype.readByFileName =
  GridFSStorage.prototype.readByName = function readByName(filename, options, done) {

    // TODO support options
    // openDownloadStreamByName(filename, options)

    //create a readable stream for a specific file
    const stream = this.storage.openDownloadStreamByName(filename, options);
